...
Regional endpoints support all DeepL API functionality except the Admin Analytics API. These endpoints are only available on the standard `api.deepl.com` endpoint. 
