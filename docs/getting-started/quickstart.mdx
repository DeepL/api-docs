...
<Steps>
  ...
  <Step title="Keep building" titleSize="h3">
    ...
    <CardGroup cols={2}>
      <Card title="Translation Beginner's Guide" icon="language" href="/docs/learning-how-tos/examples-and-guides/translation-beginners-guide">
        A hands-on tour of text translation: formality, context, language detection, and more.
      </Card>
      <Card title="Real-Time Voice Quickstart" icon="waveform-lines" href="/docs/voice/real-time-voice-quickstart">
        Stream microphone audio and print live translations to your terminal, sentence by sentence.
      </Card>
    </CardGroup>
...
- [**DeepL 101**](/docs/learning-how-tos/examples-and-guides/first-things-to-try-with-the-deepl-api) - First things to try with the API: document translation, Postman, and the developer community
