...
This tab has two subtabs: "Developer Keys" and "Admin API Keys." The sections below — filtering, creating, copying, renaming, deactivating, setting usage limits, and setting permissions — all describe the "Developer Keys" subtab. See [Manage admin API keys](#manage-admin-api-keys) for how the "Admin API Keys" subtab differs.
