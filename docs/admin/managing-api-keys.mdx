...
This tab has two subtabs: "Developer Keys" and "Admin Keys." The sections below — filtering, creating, copying, renaming, deactivating, setting usage limits, and setting permissions — all describe the "Developer Keys" subtab. See [Manage admin API keys](#manage-admin-api-keys) for how the "Admin Keys" subtab differs.
...
![](/_assets/images/filter-api-keys.png)
</Frame>
...
On the API Pro, API Growth, and API Enterprise plans, you manage [admin keys](/docs/admin/overview#the-admin-api) on the "Admin Keys" subtab of the ["API Keys & Limits" tab](https://www.deepl.com/your-account/keys?keyType=admin).

<Frame caption="The Admin Keys subtab">
![](/_assets/images/admin-api-tab.png)
</Frame>

Admin keys support the same actions as developer keys: create, copy, rename, and deactivate them from the "Admin Keys" subtab exactly as described above. The differences:
