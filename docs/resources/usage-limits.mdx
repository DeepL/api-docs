...
description: "Request size, header, and character limits for the DeepL API, plus the maximum upload size for each document format."
---
...
| File Format             | DeepL API - free plans         | DeepL API - paid plans           |
| ----------------------- | ------------------------------ | -------------------------------- |
