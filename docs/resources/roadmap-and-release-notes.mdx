...
- Added [`GET /v2/admin/analytics/custom-tags`](/api-reference/admin-api/custom-tag-usage-analytics) to the Admin API, allowing admins to retrieve usage statistics broken down by custom tags.
