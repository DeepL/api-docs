...
- Create an admin key in the ["Admin Keys" subtab](https://www.deepl.com/your-account/keys?keyType=admin) of your account to get started. See [Managing API Keys in the Account UI](/docs/admin/managing-api-keys#manage-admin-api-keys) for instructions, or jump into the [Admin API Quickstart](/docs/admin/quickstart).
