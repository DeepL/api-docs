...
Use the [/write/rephrase](/docs/translate/write-api) endpoint to rephrase text into the target language variant.
...
- **Learn about the Write API:** Explore the [/write/rephrase endpoint](/docs/translate/write-api) for high-quality variant translation and rephrasing
