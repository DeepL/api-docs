...
<Card title="GitHub - DeepL/deepl-api-nodejs-proxy" icon="github" horizontal href="https://github.com/DeepL/deepl-api-nodejs-proxy">
...
<Frame caption="Node.js proxy server running in a terminal">
  <img src="https://raw.githubusercontent.com/DeepL/deepl-api-nodejs-proxy/main/assets/proxy-running.png" alt="Node.js proxy server running and ready to accept requests" />
</Frame>

<Frame caption="Interactive web demo interface for testing translations">
  <img src="https://raw.githubusercontent.com/DeepL/deepl-api-nodejs-proxy/main/assets/dashboard-demo.png" alt="Interactive web demo interface for testing translations" />
</Frame>
