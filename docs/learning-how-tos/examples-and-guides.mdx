...
---
<CardGroup cols={2}>
  <Card title="Translate Text Quickstart" horizontal href="/docs/translate/translate-text-quickstart">
  </Card>
  <Card title="Translate Documents Quickstart" horizontal href="/docs/translate/translate-documents-quickstart">
  </Card>
  <Card title="Mustache placeholder tags" horizontal href="/docs/learning-how-tos/examples-and-guides/placeholder-tags">    
  </Card>
  <Card title="Glossaries in the real world" horizontal href="/docs/customize/glossaries-in-the-real-world">
  </Card>
