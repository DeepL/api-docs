...
<Steps>
  ...
  <Step title="Poll the job">
    ...
    ```json
    {
      ...
      "updated_at": "2026-08-06T15:06:11.418Z",
      "source_file": {
        "content_type": "application/xml",
        "content_length": 1024
      },
...
`content_length` must be greater than 0 and within DeepL's size limit for TMX imports. An oversize value is rejected as `400 Bad Request` with a message pointing at `source_file.content_length`.
